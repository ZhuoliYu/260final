...
const MainPage = ({ prevWatchList }) => {
  ...
  //const [watchedMovies, setWatchedMovies] = useState(prevWatchList || []);
  ...
  useEffect(() => {
    localStorage.setItem("watchMovieList", JSON.stringify(watchedMovies));
  }, [watchedMovies]);
